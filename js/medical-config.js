...
var TREND_MESSAGES = {
  egfr: {
    improving:   "eGFR 趋势向好",
    rapidDecline:"eGFR 下降较快",
    slowDecline: "eGFR 缓慢下降",
    stable:      "eGFR 稳定",
    rapidAdvice: "建议复诊时与医生讨论",
  },
  scr: {
    significantRise: "肌酐上升明显",
    slightRise:      "肌酐略有上升",
    improved:        "肌酐有改善",
    riseAdvice:      "肌酐短期大幅上升需关注，建议尽早复诊",
  },
  k: {
    dangerHigh: "血钾偏高",
    warnHigh:   "血钾偏高边缘",
    warnLow:    "血钾偏低",
    dangerDetail: "高钾血症有心脏风险，需限制高钾食物并复诊",
  },
  bp: {
    high:      "血压偏高",
    improving: "血压改善趋势",
    good:      "血压控制良好",
    needWatch: "血压需继续关注",
    highAdvice:"建议复诊时与医生讨论",
  },
  weight: {
    increase: "体重上升",
    decrease: "体重下降",
    fluctuationNote: "短期体重波动可能反映水钠潴留",
  },
};
