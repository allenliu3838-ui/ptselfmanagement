...
function defaultState(){
  ...
  return {
    ...
    ui: { overlayReturn: 'home', explainerId: '', showAI: true, homeMoreDefault: false, seenSummaryNudge: false, simpleMode: false },
...
function loadState(){
  try{
    ...
    if(st.ui && typeof st.ui.simpleMode === "undefined") st.ui.simpleMode = false;
