const CACHE_NAME = "kidney-care-v10.1.0";
const ASSETS = [
  "./",
  "./index.html",
  "./style.css",
  "./js/constants.js?v=10.1",
  "./js/medical-config.js?v=10.1",
  "./js/utils.js?v=10.1",
  "./js/state.js?v=10.1",
  "./js/tracking.js?v=10.1",
  "./js/educationEngine.js?v=10.1",
  "./js/programs.js?v=10.1",
  "./js/tasks.js?v=10.1",
  "./js/db.js?v=10.1",
  "./js/diet.js?v=10.1",
  "./js/render.js?v=10.1",
  ...
  "./js/export.js?v=10.1",
  "./js/trends.js?v=10.1",
  "./js/premium.js?v=10.1",
  "./js/ocr.js?v=10.1",
  "./js/share.js?v=10.1",
  "./js/ai.js?v=10.1",
  "./js/summary.js?v=10.1",
  "./js/ui.js?v=10.1",
  "./js/educationContent.js?v=10.1",
  "./js/app.js?v=10.1",
